...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <section className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            <h3 className="text-xl mb-8 font-semibold border-b pb-4">Añadir comentario</h3>
            ...
            <div className="mt-8 w-32 mx-auto lg:w-auto">
                <button
                    ...
                    className="transition duration-500 ease font-semibold hover:bg-white border-2 hover:border-black hover:text-black inline-block bg-black text-lg rounded-full text-white px-8 py-3 cursor-pointer"
                >
                    Publicar
                </button>
